      ...
      {/* Navbar */}
        <div className="fixed top-0 left-0 w-full flex flex-col sm:flex-row text-center justify-between px-4 sm:px-6 py-3 border-b bg-white shadow-sm h-auto sm:h-18 z-50">
          <div className="flex items-center space-x-2">
            <img src="/assets/logo.svg" alt="WeLearn_Logo" className="w-14 h-14 md:w-18 md:h-18" />
        ...
        <section className="mx-auto w-full pt-40 pb-20 px-4">
          ...
          <Title className="text-center">Learn from Peers, Teach Your Passion</Title>
          ...
          <div className="grid gap-12 md:grid-cols-3 max-w-4xl mx-auto justify-items-center items-center">
            {[
              ...
              <div key={index} className="flex flex-col items-center text-center max-w-xs mx-auto">
                <div className="w-8 h-8 rounded-full flex items-center justify-center text-[#F0FAF9] bg-[#1F65A6] text-md mb-8">{index + 1}</div>
