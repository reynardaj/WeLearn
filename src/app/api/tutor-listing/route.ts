    ...
    `
      ...
      eligible AS (
        ...
        LEFT JOIN (
          ...
          FROM "review"
          GROUP BY "tutorID"
        ) r_stats ON r_stats."tutorID" = t."tutorid"
        ...
        GROUP BY
          t."tutorid", t."firstname", t."lastname",
          t."institution", t."price", t."profileimg",
          t."isPro", r_stats.avg_rating
      ),
      matched AS (
        SELECT
          e.*,
      ...
      SELECT
        ...
        "price",
        "profileimg",
        -- only true if flagged pro *and* they teach one of the tutee's subjects
        ("isPro" AND matches_tutee_subjects) AS "isPro",
        rating,
        subjects,
        availability
      FROM numbered
